# Copilot-instructies voor Clio

## Scope en architectuur
- Deze applicatie draait volledig vanuit de map `/web/` en wordt gepubliceerd onder `https://sleutels.kvt.nl/clio`.
- Houd links daarom relatief (`index.php`, `odata.php?...`) of vanaf `/clio/...` als absolute paden nodig zijn.
