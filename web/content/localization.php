...
const TRANSLATIONS = [
    ...
    'nl' => [
        ...
        'upload.error.request_empty' => 'De upload kwam leeg aan op de server. Controleer PHP upload-instellingen, tijdelijke uploadmap en Apache-limieten.',
        'upload.error.server_size' => 'Het bestand is groter dan de uploadlimiet van de server.',
        'upload.error.form_size' => 'Het bestand overschrijdt de toegestane formulierlimiet.',
        'upload.error.partial' => 'Het bestand is maar gedeeltelijk geupload. Probeer het opnieuw.',
        'upload.error.no_tmp_dir' => 'De server mist een tijdelijke uploadmap.',
        'upload.error.cant_write' => 'De server kon het uploadbestand niet wegschrijven.',
        'upload.error.extension_blocked' => 'De upload is door een serverextensie geblokkeerd.',
        ...
        'email.title' => 'Email Archief',
        'email.description' => 'Gearchiveerde mailbox-conversaties per chain-id.',
        'email.empty' => 'Er zijn nog geen emails gearchiveerd.',
        'email.open' => 'Open',
        'email.preview_title' => 'Emails',
        'email.preview_placeholder' => 'Kies links een emailconversatie om de berichten te tonen.',
        'email.contacts' => 'Contactpersonen',
        'email.message_count' => '%d emails',
        'email.from' => 'Van: %s',
        'email.to' => 'Aan: %s',
        'email.date' => 'Datum: %s',
        'email.thread_not_found' => 'Emailconversatie niet gevonden.',
        'email.load_failed' => 'Kon emailarchief niet laden: %s',
        'email.search_label' => 'Zoeken in emails',
        'email.search_placeholder' => 'Zoek op onderwerp, ontvangers of inhoud…',
        'email.search_no_results' => 'Geen emails gevonden voor deze zoekterm.',
        'email.download_eml' => 'Download .eml',
        'email.download_failed' => 'Kon het .eml-bestand niet downloaden.',
        'flash.error' => 'Fout: %s',
    ...
    'en' => [
        ...
        'upload.error.request_empty' => 'The upload reached the server empty. Check PHP upload settings, the temporary upload directory, and Apache limits.',
        'upload.error.server_size' => 'The file exceeds the server upload limit.',
        'upload.error.form_size' => 'The file exceeds the allowed form limit.',
        'upload.error.partial' => 'The file was only partially uploaded. Please try again.',
        'upload.error.no_tmp_dir' => 'The server is missing a temporary upload directory.',
        'upload.error.cant_write' => 'The server could not write the uploaded file.',
        'upload.error.extension_blocked' => 'The upload was blocked by a server extension.',
        ...
        'email.title' => 'Email archive',
        'email.description' => 'Archived mailbox conversations by chain id.',
        'email.empty' => 'No emails have been archived yet.',
        'email.open' => 'Open',
        'email.preview_title' => 'Emails',
        'email.preview_placeholder' => 'Select an email conversation on the left to display its messages.',
        'email.contacts' => 'Contacts',
        'email.message_count' => '%d emails',
        'email.from' => 'From: %s',
        'email.to' => 'To: %s',
        'email.date' => 'Date: %s',
        'email.thread_not_found' => 'Email conversation not found.',
        'email.load_failed' => 'Could not load email archive: %s',
        'email.search_label' => 'Search emails',
        'email.search_placeholder' => 'Search subject, recipients, or body…',
        'email.search_no_results' => 'No emails found for this search term.',
        'email.download_eml' => 'Download .eml',
        'email.download_failed' => 'Could not download the .eml file.',
        'flash.error' => 'Error: %s',
    ...
    'de' => [
        ...
        'upload.error.request_empty' => 'Der Upload kam leer auf dem Server an. Pruefen Sie PHP-Upload-Einstellungen, das temporaere Upload-Verzeichnis und Apache-Limits.',
        'upload.error.server_size' => 'Die Datei ueberschreitet das Upload-Limit des Servers.',
        'upload.error.form_size' => 'Die Datei ueberschreitet das erlaubte Formularlimit.',
        'upload.error.partial' => 'Die Datei wurde nur teilweise hochgeladen. Bitte erneut versuchen.',
        'upload.error.no_tmp_dir' => 'Auf dem Server fehlt ein temporaeres Upload-Verzeichnis.',
        'upload.error.cant_write' => 'Der Server konnte die hochgeladene Datei nicht speichern.',
        'upload.error.extension_blocked' => 'Der Upload wurde von einer Server-Erweiterung blockiert.',
        ...
        'email.title' => 'E-Mail-Archiv',
        'email.description' => 'Archivierte Mailbox-Konversationen nach Chain-ID.',
        'email.empty' => 'Es wurden noch keine E-Mails archiviert.',
        'email.open' => 'Oeffnen',
        'email.preview_title' => 'E-Mails',
        'email.preview_placeholder' => 'Waehlen Sie links eine E-Mail-Konversation aus, um die Nachrichten anzuzeigen.',
        'email.contacts' => 'Kontakte',
        'email.message_count' => '%d E-Mails',
        'email.from' => 'Von: %s',
        'email.to' => 'An: %s',
        'email.date' => 'Datum: %s',
        'email.thread_not_found' => 'E-Mail-Konversation nicht gefunden.',
        'email.load_failed' => 'E-Mail-Archiv konnte nicht geladen werden: %s',
        'email.search_label' => 'E-Mails durchsuchen',
        'email.search_placeholder' => 'Suche nach Betreff, Empfaengern oder Inhalt…',
        'email.search_no_results' => 'Keine E-Mails fuer diesen Suchbegriff gefunden.',
        'email.download_eml' => '.eml herunterladen',
        'email.download_failed' => 'Die .eml-Datei konnte nicht heruntergeladen werden.',
    ...
    'fr' => [
        ...
        'upload.error.request_empty' => 'Le televersement est arrive vide sur le serveur. Verifiez les reglages PHP, le dossier temporaire et les limites Apache.',
        'upload.error.server_size' => 'Le fichier depasse la limite de televersement du serveur.',
        'upload.error.form_size' => 'Le fichier depasse la limite autorisee du formulaire.',
        'upload.error.partial' => 'Le fichier n a ete televerse qu en partie. Veuillez reessayer.',
        'upload.error.no_tmp_dir' => 'Le serveur ne dispose pas d un dossier temporaire pour les televersements.',
        'upload.error.cant_write' => 'Le serveur n a pas pu ecrire le fichier televerse.',
        'upload.error.extension_blocked' => 'Le televersement a ete bloque par une extension du serveur.',
        ...
        'email.title' => 'Archive e-mail',
        'email.description' => 'Conversations de messagerie archivees par chain-id.',
        'email.empty' => 'Aucun e-mail n a encore ete archive.',
        'email.open' => 'Ouvrir',
        'email.preview_title' => 'E-mails',
        'email.preview_placeholder' => 'Selectionnez une conversation e-mail a gauche pour afficher les messages.',
        'email.contacts' => 'Contacts',
        'email.message_count' => '%d e-mails',
        'email.from' => 'De : %s',
        'email.to' => 'A : %s',
        'email.date' => 'Date : %s',
        'email.thread_not_found' => 'Conversation e-mail introuvable.',
        'email.load_failed' => 'Impossible de charger l archive e-mail : %s',
        'email.search_label' => 'Rechercher des e-mails',
        'email.search_placeholder' => 'Rechercher sujet, destinataires ou contenu…',
        'email.search_no_results' => 'Aucun e-mail trouve pour ce terme de recherche.',
        'email.download_eml' => 'Telecharger .eml',
        'email.download_failed' => 'Impossible de telecharger le fichier .eml.',
